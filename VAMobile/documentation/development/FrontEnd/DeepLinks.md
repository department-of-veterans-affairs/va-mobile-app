...
- If the user is on iOS and clicks a universal link from within the VA.gov domain, it will display a [smart banner](https://department-of-veterans-affairs.github.io/va-mobile-app/development/FrontEnd/SmartBanners) recommending to open the app instead of opening the app directly.
