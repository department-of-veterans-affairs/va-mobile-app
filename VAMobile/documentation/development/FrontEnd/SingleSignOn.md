...
| :--- | :--- | :--- | :--- |
| [`vama_login_start`](https://analytics.google.com/analytics/web/?authuser=0&hl=en-US#/a50123418p265787033/reports/dashboard?params=_u..insightCards%3D%5B%7B%22question%22:%22notification_receive%22%7D%5D%26_u..nav%3Dmaui%26_r..dimension-value%3D%7B%22dimension%22:%22eventName%22,%22value%22:%22vama_login_start%22%7D&collectionId=user&r=events-overview) |  `p1` (biometric: string) | User taps 'Sign In'. `p1` indicates if it started via biometrics. | **Top of Funnel.** Tracks intent to log in. |
| [`vama_login_success`](https://analytics.google.com/analytics/web/?authuser=0&hl=en-US#/a50123418p265787033/reports/dashboard?params=_u..insightCards%3D%5B%7B%22question%22:%22notification_receive%22%7D%5D%26_u..nav%3Dmaui%26_r..dimension-value%3D%7B%22dimension%22:%22eventName%22,%22value%22:%22vama_login_success%22%7D&collectionId=user&r=events-overview) |  | Final step: Tokens validated and app state updated to 'logged in'. | **Success Metric.** Conversion endpoint. |
| [`vama_login_fail`](https://analytics.google.com/analytics/web/?authuser=0&hl=en-US#/a50123418p265787033/reports/dashboard?params=_u..insightCards%3D%5B%7B%22question%22:%22notification_receive%22%7D%5D%26_u..nav%3Dmaui%26_r..dimension-value%3D%7B%22dimension%22:%22eventName%22,%22value%22:%22vama_login_fail%22%7D&collectionId=user&r=events-overview) | `error` (string) | General failure catch-all in the thunk layer. | **Churn Point.** Technical failure during the flow. |
...
| `saveRefreshTokenWithBiometrics` (No errors logged) | N/A | **Low.** Keychain storage issue (hardware/permissions). |
