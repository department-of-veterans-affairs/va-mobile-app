...
- Ensure that the new test has been added to the array/dictionary in the NavigationShared.e2e and AvailabilityFramework.e2e tests (if needed). How to add new tests can be found [here](./EndToEndTesting.md)
