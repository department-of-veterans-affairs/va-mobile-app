...
sidebar_position: 1
---
The Mobile Platform and Experience teams work together to deliver high-quality, cohesive mobile experiences for Veterans in the VA Health and Benefits app. While the Mobile Platform team provides the core infrastructure, standards, and guardrails that ensure consistency and reliability, Experience teams bring deep expertise in their product areas and own the functionality they deliver.  Below we outline the process for an Experience team to work with the Mobile Platform to build functionality into the app.
