...
![Mac downloads directory](../../../static/img/making_changes/ss1.png)
...
![example warning](../../../static/img/making_changes/ss2.png)

When the app opens it may ask you to log into GitHub.

Once you are logged in you should see a screen like this:

![getting started screen](../../../static/img/making_changes/ss3.png)

Wait until your repositories list loads on the right

![list of repositories in the app](../../../static/img/making_changes/ss4.png)
...
![highlighted text for the va-mobile-app repo](../../../static/img/making_changes/ss5.png)
...
![example of fetching by URL](../../../static/img/making_changes/ss6.png)

![cloning loading screen](../../../static/img/making_changes/ss7.png)

![status update screen with no changes](../../../static/img/making_changes/ss8.png)
...
![example branching model with dots and lines](../../../static/img/making_changes/ss10.png)
...
![comparing your branch to develop](../../../static/img/making_changes/ss11.png)
...
![searching for a branch name](../../../static/img/making_changes/ss12.png)
...
![creating a new branch](../../../static/img/making_changes/ss13.png)

Once you have created your branch, you should see this:

![status screen showing no changes](../../../static/img/making_changes/ss14.png)
...
![searching for a release branch](../../../static/img/making_changes/ss15.png)
...
![release branch appearing in search results](../../../static/img/making_changes/ss16.png)
...
![opening the repo](../../../static/img/making_changes/ss17.png)
...
![a mac desktop opening a code editor](../../../static/img/making_changes/ss18.gif)
...
![changes active in the app UI](../../../static/img/making_changes/ss19.png)
...
![example of viewing changed files](../../../static/img/making_changes/ss20.png)
![another example of viewing changed files](../../../static/img/making_changes/ss21.png)
...
![three circled checkboxes](../../../static/img/making_changes/ss22.png)
...
![example commit](../../../static/img/making_changes/ss23.png)
...
![publish branch options circled](../../../static/img/making_changes/ss24.png)

![status screen showing no changes](../../../static/img/making_changes/ss25.png)
...
![Github UI with an open pull request](../../../static/img/making_changes/ss26.png)
...
![connecting an issue to zenhub](../../../static/img/making_changes/ss27.png)

Click `Connect Issue` and search for the ticket by title or number

![searching for an issue](../../../static/img/making_changes/ss28.png)
![finding the issue you need](../../../static/img/making_changes/ss29.png)
Once you have connected the issue, you should see something like this:

![github UI with the issue connected](../../../static/img/making_changes/ss30.png)
