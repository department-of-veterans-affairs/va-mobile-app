...
### Variations
<iframe width="800" height="450" alt="Image of component examples in Figma showing the Tag component in light and dark mode" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com/file/QVLPB3eOunmKrgQOuOt0SU/%F0%9F%93%90-DesignLibrary2.0---VAMobile?type=design&node-id=8429-12895&mode=design&t=KnuQLCCqRJnHgKVJ-4" allowfullscreen></iframe>
...
- Clearly and accurately use common VA language, words, or terms.
- Use the trailing info-icon as an option. The status definition will not apply in all use cases. 
- Present text in Title Case (i.e. Pending. Not PENDING or pending).
