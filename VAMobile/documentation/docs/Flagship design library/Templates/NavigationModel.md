...
* **Secondary navigation:**
  * The right side of the app’s top navigation bar is reserved for global contextual features that relate to the content on that screen (Example: Profile, Help).
  ...
  For ENG components that make up the primary navigation, see [Primary Navigation](/docs/Flagship%20design%20library/Components/Navigation/Primary/) in the UX Components section.
