...
const config = {
  title: 'VA Mobile App Documentation',
  ...
  presets: [
    [
      ...
      /** @type {import('./documentation/node_modules/@docusaurus/preset-classic').Options} */
      ({
        docs: {
        ...
        theme: {
          customCss: require.resolve('./documentation/src/css/custom.css'),
        },
      }),
    ],
  ],
  ...
  themeConfig:
    /** @type {import('./documentation/node_modules/@docusaurus/preset-classic').ThemeConfig} */
    ({
      navbar: {
