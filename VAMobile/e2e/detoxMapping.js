...
const detoxMapping = {
  directory: {
    ...
    Pharmacy: ['Prescriptions', 'RefillPrescriptions', 'ReviewPrescriptions'],
    prescriptions: ['Prescriptions', 'RefillPrescriptions', 'ReviewPrescriptions'],
  ...
  files: {
    ...
    'prescriptions.json': ['Prescriptions', 'RefillPrescriptions', 'ReviewPrescriptions'],
