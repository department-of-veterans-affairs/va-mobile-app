...
// AVS error messages to check for in order to determine if there was an error retrieving the AVS PDF

export const AVS_BINARY_ERRORS_WITH_ALERT = ['Error retrieving AVS binary']
export const AVS_BINARY_ERRORS_IGNORED = ['Retrieved empty AVS binary']
