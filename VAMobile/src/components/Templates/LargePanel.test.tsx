...
context('LargePanel', () => {
  ...
  const initializeTestInstance = (titleText?:string ,leftButtonText?:string, rightButtonText?:string, footerButtonText?:string, onFooterButtonPress?:() => void): void => {
    ...
    component = render(
      <LargePanel title={titleText} leftButtonText={leftButtonText} rightButtonText={rightButtonText} footerButtonText={footerButtonText} onFooterButtonPress={onFooterButtonPress}
      />,
    )
