...
context('FullScreenSubtask', () => {
  ...
  const initializeTestInstance = (titleText?:string ,leftButtonText?:string, rightButtonText?:string, rightVAIconProps?:VAIconProps, primaryContentButtonText?:string, onPrimaryButtonPress?:() => void, secondaryContentButtonText?:string, onSecondaryButtonPress?:() => void): void => {
    onPressSpy = jest.fn(() => {})

    component = render(
      <FullScreenSubtask title={titleText} leftButtonText={leftButtonText} rightButtonText={rightButtonText} rightVAIconProps={rightVAIconProps} primaryContentButtonText={primaryContentButtonText} onPrimaryContentButtonPress={onPrimaryButtonPress} secondaryContentButtonText={secondaryContentButtonText} onSecondaryContentButtonPress={onSecondaryButtonPress}
      />,
    )
