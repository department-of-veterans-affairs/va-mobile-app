  ...
  return (
    <Box>
      <Box {...headerWrapperProps}>
        <TextView variant={'HelperText'} accessibilityLabel={t('selectedOutOfTotal.a11yLabel', { selected: numSelected, total: items.length })}>
          {t('selectedOutOfTotal', { selected: numSelected, total: items.length })}
        </TextView>
