...
context('AccordionCollapsible', () => {
  ...
  describe('should render correctly', () => {
    it('when it is setup as default', async () => {
    ...
    it('when pressed should display the expanded content and hide the collapsed and calls custom on press', async () => {
    ...
    it('when hideArrow set to true, cannot find tab to press', async () => {
      initializeTestInstance(true)
      expect(screen.queryByRole('tab')).toBeFalsy()
    })

    it('when expandedIntiailValue is true it should show Expanded and not Collapsed content on load', async () => {
