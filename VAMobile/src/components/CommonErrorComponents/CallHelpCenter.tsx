...
const CallHelpCenter: FC<CallHelpCenterProps> = ({ onTryAgain, background, title, titleA11y, errorText, errorA11y, callPhone, noScrollView }) => {
  ...
  const getMainContents = (): ReactNode => {
    return (
      <AlertBox
  ...
  return !noScrollView ? (
    ...
    <Box justifyContent="center" my={theme.dimensions.condensedMarginBetween}>
      {getMainContents()}
    </Box>
  )
}
