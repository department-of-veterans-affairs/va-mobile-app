...
/** TODO: Delete this. This back compat version of the card is the old component. Using this until the implementation
 * of the new style card is done so we don't lose functionality while working on the updates */

export type MultiTouchCardBackCompatProps = {
...
const MultiTouchCardBackCompat: FC<MultiTouchCardBackCompatProps> = ({
  topText,
  topTextColor,
  topBackgroundColor,
  a11yValue,
...
export default MultiTouchCardBackCompat
