 ...
 */
const downloadDecisionLetter = async (id: string, demoMode: boolean): Promise<boolean | undefined> => {
 ...
 */
export const useDownloadDecisionLetter = (id: string, demoMode: boolean, options?: { enabled?: boolean }) => {
  return useQuery({
    ...options,
    queryKey: [decisionLettersKeys.downloadLetter, id],
    queryFn: () => downloadDecisionLetter(id, demoMode),
    meta: {
