...
context('HowToUpdateDirectDepositScreen', () => {
  ...
  it('initializes correctly', () => {
    ...
    expect(screen.getByRole('header', { name: "You’ll need to sign in with a verified ID.me or Login.gov account to update your direct deposit information" })).toBeTruthy()
