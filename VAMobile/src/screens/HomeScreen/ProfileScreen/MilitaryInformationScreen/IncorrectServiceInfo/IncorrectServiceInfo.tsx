...
import { Box, ClickForActionLink, LargePanel, LinkTypeOptionsConstants, TextView, WaygateWrapper } from 'components'
...
const IncorrectServiceInfo: FC<IncorrectServiceInfoScreenProps> = () => {
  ...
  return (
    <LargePanel title={t('profile.help.title')} rightButtonText={t('close')} testID="IncorrectServiceTestID">
      <WaygateWrapper waygate="WG_IncorrectServiceInfoScreen">
