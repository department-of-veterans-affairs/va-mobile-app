...
import { Box, BoxProps, LargePanel, TextView, VAIcon } from 'components'
...
const VeteranStatusScreen: FC<VeteranStatusScreenProps> = () => {
  ...
  const boxProps: BoxProps = {
    ...
    borderColor: theme.colors.border.veteranStatus,
    borderStyle: 'solid',
  }
  ...
  return (
    <LargePanel title={t('veteranStatus.title')} rightButtonText={t('close')}>
      <Box backgroundColor={theme.colors.background.veteranStatus} flex={1}>
        <Box alignItems="center">
          <Box mt={theme.dimensions.standardMarginBetween}>
            <VAIcon name={'Logo'} />
          </Box>
          <Box mt={theme.dimensions.standardMarginBetween}>
            <PhotoUpload width={101} height={128} />
          </Box>
