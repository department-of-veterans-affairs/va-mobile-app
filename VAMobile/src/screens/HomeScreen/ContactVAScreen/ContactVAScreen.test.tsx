...
context('ContactVAScreen', () => {
  ...
  it('initializes correctly', async () => {
    ...
    expect(children[0].props.children).toBe('Call MyV\uFEFFA\uFEFF4\uFEFF1\uFEFF1')
    expect(children[1].props.children).toBe('MyV\uFEFFA\uFEFF4\uFEFF1\uFEFF1 is our main VA information line. We can help connect you to any of our V\uFEFFA contact centers.')
