...
import { initialAuthorizedServicesState, initialAuthState, initialMilitaryServiceState, initialPersonalInformationState } from 'store/slices'
import { SyncScreen } from './index'
import TextView from '../../components/TextView'
import { completeSync, getProfileInfo, getServiceHistory } from 'store/slices'
...
context('SyncScreen', () => {
  ...
  const initializeTestInstance = (militaryLoading = true, profileLoading = true, loggedIn = false, loggingOut = false, syncing = true): void => {
    store = {
