...
import { initialAuthState, initialClaimsAndAppealsState, initialDisabilityRatingState, initialMilitaryServiceState } from 'store/slices'
import { SyncScreen } from './index'
import { completeSync, getDisabilityRating, getServiceHistory, prefetchClaimsAndAppeals } from 'store/slices'
...
context('SyncScreen', () => {
  ...
  const initializeTestInstance = (militaryLoading = true, disabilityRatingLoading = true, claimsAndAppealsLoading = true, loggedIn = false, loggingOut = false, syncing = true): void => {
    store = {
