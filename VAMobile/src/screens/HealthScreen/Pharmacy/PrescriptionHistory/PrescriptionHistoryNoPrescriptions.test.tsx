...
context('PrescriptionHistoryNoPrescriptions', () => {
  it('initializes correctly', () => {
    ...
    expect(screen.getByText('If you think this is an error, or if you have questions about your VA prescriptions, please call the My HealtheVet help desk. We’re here Monday through Friday, 8:00 AM to 8:00 PM ET.')).toBeTruthy()
