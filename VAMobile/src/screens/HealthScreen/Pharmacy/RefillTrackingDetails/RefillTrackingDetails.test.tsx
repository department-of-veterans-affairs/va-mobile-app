...
context('RefillTrackingDetails', () => {
  ...
  describe('when there are one tracking for a prescription', () => {
    it('should show tracking information', async  () => {
      ...
      // Header
      expect(texts[0].props.children).toEqual('ALLOPURINOL 100MG TAB')
      expect(texts[1].props.children).toEqual('Rx #: 3636691')
      ...
      // Tracking Information
      expect(texts[3].props.children).toEqual('Tracking number')
      expect(texts[4].props.children).toEqual('7534533636856')
      expect(texts[5].props.children).toEqual('Delivery service: DHL')
      expect(texts[6].props.children).toEqual('Date shipped: 06/14/2022')
      // Other Prescriptions
      expect(texts[7].props.children).toEqual('Other prescriptions in this package:')
      expect(texts[8].props.children).toEqual('LAMIVUDINE 10MG TAB')
      expect(texts[9].props.children).toEqual('Rx #: 2336800')
      expect(texts[10].props.children).toEqual('ZIDOVUDINE 1MG CAP')
      expect(texts[11].props.children).toEqual('Rx #: None noted')
    })
  })
  ...
  describe('when there are multiple tracking for a prescription', () => {
    it('should show information for each tracking with "x of total" header ', async  () => {
      ...
      expect(texts[3].props.children).toEqual('Package 1 of 2')
      expect(texts[4].props.children).toEqual('Tracking number')
      expect(texts[5].props.children).toEqual('7534533636856')
      expect(texts[6].props.children).toEqual('Delivery service: DHL')
      expect(texts[7].props.children).toEqual('Date shipped: 06/14/2022')
      // Other Prescriptions
      expect(texts[8].props.children).toEqual('Other prescriptions in this package:')
      expect(texts[9].props.children).toEqual('LAMIVUDINE 10MG TAB')
      expect(texts[10].props.children).toEqual('Rx #: 2336800')
      expect(texts[11].props.children).toEqual('ZIDOVUDINE 1MG CAP')
      expect(texts[12].props.children).toEqual('Rx #: None noted')

      // Tracking Information #2
      expect(texts[13].props.children).toEqual('Package 2 of 2')
      expect(texts[14].props.children).toEqual('Tracking number')
      expect(texts[15].props.children).toEqual('5634533636812')
      expect(texts[16].props.children).toEqual('Delivery service: USPS')
      expect(texts[17].props.children).toEqual('Date shipped: 06/28/2022')
      // Other Prescriptions
      expect(texts[18].props.children).toEqual('Other prescriptions in this package:')
      expect(texts[19].props.children).toEqual('AMLODIPINE BESYLATE 10MG TAB')
      expect(texts[20].props.children).toEqual('Rx #: 3636711A')
      expect(texts[21].props.children).toEqual('ZIDOVUDINE 1MG CAP')
      expect(texts[22].props.children).toEqual('Rx #: 4636722C')
    })
  })
