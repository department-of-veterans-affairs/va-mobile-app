...
import VideoAtlasAppointment from 'screens/HealthScreen/Appointments/AppointmentTypeComponents/VideoAtlasAppointment'
...
context('VideoAtlasAppointment', () => {
  ...
  describe('VideoAtlasAppointment Upcoming', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByRole('header', { name: t('appointments.videoAtlas.upcomingTitle') })).toBeTruthy()
      expect(screen.getByText(t('appointments.videoAtlas.upcomingBody', { code: '123 code' }))).toBeTruthy()
      ...
      expect(
        screen.getByText(t('upcomingAppointmentDetails.doYouNeedToCancelOrReschedule.videoNonVA.body')),
      ).toBeTruthy()
    ...
    it('renders correctly with null data', () => {
      ...
      initializeTestInstance(attributes, AppointmentDetailsSubTypeConstants.Upcoming)
      expect(screen.getByRole('header', { name: t('appointments.videoAtlas.upcomingTitle') })).toBeTruthy()
      expect(screen.getByText(t('appointments.videoAtlas.upcomingBody', { code: '' }))).toBeTruthy()
      ...
      expect(screen.getByText(t('appointments.inPersonVA.missingAddress.goToVALink'))).toBeTruthy()
  ...
  describe('VideoAtlasAppointment Past', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
      }
      ...
      expect(
        screen.getByRole('header', {
          name: t('appointments.pastTitle', {
            appointmentType:
              t('appointments.videoAtlas.upcomingTitle').charAt(0).toLowerCase() +
              t('appointments.videoAtlas.upcomingTitle').slice(1),
          }),
        }),
      ).toBeTruthy()
  ...
  describe('VideoAtlasAppointment Canceled', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
  ...
  describe('VideoAtlasAppointment Pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
  ...
  describe('VideoAtlasAppointment canceled pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
        status: AppointmentStatusConstants.CANCELLED,
  ...
  describe('VideoAtlasAppointment Canceled and Canceled Pending different cancel types that are not patient', () => {
