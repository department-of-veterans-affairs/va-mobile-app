...
context('ClaimExamAppointment', () => {
  ...
  describe('ClaimExamAppointment Upcoming', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByText(t('appointmentsTab.medicationWording.claimExam.bulet1'))).toBeTruthy()
      expect(screen.getByText(t('appointmentsTab.medicationWording.claimExam.bulet2'))).toBeTruthy()
