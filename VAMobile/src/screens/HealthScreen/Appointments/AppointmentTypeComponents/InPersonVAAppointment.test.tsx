...
import InPersonVAAppointment from 'screens/HealthScreen/Appointments/AppointmentTypeComponents/InPersonVAAppointment'
...
context('InPersonVAAppointment', () => {
  ...
  describe('InPersonVAAppointment Upcoming', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByRole('header', { name: t('appointments.inPersonVA.upcomingTitle') })).toBeTruthy()
      expect(
        screen.getByText(
          t('appointments.inPersonVA.upcomingBody', { facilityName: 'VA Long Beach Healthcare System' }),
        ),
      ).toBeTruthy()
      expect(
        screen.getByLabelText(
          t('appointments.inPersonVA.upcomingBody', { facilityName: a11yLabelVA('VA Long Beach Healthcare System') }),
        ),
      ).toBeTruthy()
      ...
      expect(
        screen.getByText(t('upcomingAppointmentDetails.doYouNeedToCancelOrReschedule.inAppCancel.body')),
      ).toBeTruthy()

      expect(screen.getByRole('button', { name: t('appointments.cancelAppointment') })).toBeTruthy()
      expect(screen.getByAccessibilityHint(t('appointments.cancelThisAppointment'))).toBeTruthy()
    })
      ...
      expect(
        screen.getByRole('header', {
          name: t('appointments.pastTitle', {
            appointmentType: t('appointments.inPersonVA.upcomingTitle').toLowerCase(),
          }),
        }),
      ).toBeTruthy()
  ...
  describe('InPersonVAAppointment Canceled', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByRole('header', { name: t('appointments.inPersonVA.canceledTitle') })).toBeTruthy()
      expect(
        screen.getByText(
  ...
  describe('InPersonVAAppointment cerner appointments without reason and comment details', () => {
