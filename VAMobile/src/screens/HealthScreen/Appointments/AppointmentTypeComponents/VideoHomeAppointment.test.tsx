...
import VideoHomeAppointment from 'screens/HealthScreen/Appointments/AppointmentTypeComponents/VideoHomeAppointment'
...
context('VideoHomeAppointment', () => {
  ...
  describe('VideoHomeAppointment Upcoming', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByRole('header', { name: t('appointments.videoGFEHome.upcomingTitle') })).toBeTruthy()
      expect(screen.getByText(t('appointments.videoHome.timeToJoin.upcomingBody'))).toBeTruthy()
      expect(screen.getByRole('button', { name: t('upcomingAppointmentDetails.joinSession') })).toBeTruthy()
  ...
  describe('VideoHomeAppointment Past', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
      }
      ...
      expect(
        screen.getByRole('header', {
          name: t('appointments.pastTitle', {
            appointmentType: t('appointments.videoGFEHome.upcomingTitle').toLowerCase(),
          }),
        }),
      ).toBeTruthy()
  ...
  describe('VideoHomeAppointment Canceled', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
  ...
  describe('VideoHomeAppointment Pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
  ...
  describe('VideoHomeAppointment canceled pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
        status: AppointmentStatusConstants.CANCELLED,
  ...
  describe('VideoHomeAppointment Canceled and Canceled Pending different cancel types that are not patient', () => {
