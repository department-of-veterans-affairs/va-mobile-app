...
context('PhoneAppointment', () => {
  ...
  describe('PhoneAppointment Upcoming', () => {
    it('renders correctly with no null data', () => {
      ...
      expect(screen.getByRole('header', { name: t('appointments.phone.upcomingTitle') })).toBeTruthy()
      expect(screen.getByText(t('appointments.phone.upcomingBody'))).toBeTruthy()
  ...
  describe('PhoneAppointment Past', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
      }
      ...
      expect(
        screen.getByRole('header', {
          name: t('appointments.pastTitle', { appointmentType: t('appointments.phone.upcomingTitle').toLowerCase() }),
        }),
      ).toBeTruthy()
  ...
  describe('PhoneAppointment Canceled', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
      ...
      expect(
        screen.getByRole('header', {
          name: t('appointments.canceledTitle', {
            appointmentType: t('appointments.phone.upcomingTitle').toLowerCase(),
          }),
        }),
      ).toBeTruthy()
      expect(
  ...
  describe('PhoneAppointment Pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
  ...
  describe('PhoneAppointment canceled pending', () => {
    it('renders correctly with no null data', () => {
      const attributes: AppointmentAttributes = {
        ...defaultAppointmentAttributes,
        status: AppointmentStatusConstants.CANCELLED,
