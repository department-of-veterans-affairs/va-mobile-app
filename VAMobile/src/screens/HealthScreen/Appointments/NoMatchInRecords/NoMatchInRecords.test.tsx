...
context('NoMatchInRecords', () => {
  it('initializes correctly', () => {
    ...
    expect(screen.getByText("If you're enrolled in VA health care, but not currently registered as a patient at a VA health facility")).toBeTruthy()
    expect(screen.getByText("If you're not enrolled in VA health care or you don't know if you're enrolled")).toBeTruthy()
  })
})
