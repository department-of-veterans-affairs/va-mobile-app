...
context('UpcomingAppointments', () => {
  ...
  const initializeTestInstance = (upcomingCurrentPageAppointmentsByYear?: AppointmentsGroupedByYear, loading: boolean = false ) => {
    ...
    store = mockStore({
      ...
      appointments: {
        ...
        upcomingCurrentPageAppointmentsByYear,
        loadedAppointments: {
          upcoming: [],
          pastThreeMonths: [],
