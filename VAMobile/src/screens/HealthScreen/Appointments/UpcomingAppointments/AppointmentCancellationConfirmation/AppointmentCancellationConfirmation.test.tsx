...
import { cancelAppointment, ErrorsState, initialErrorsState, initializeErrorsByScreenID, InitialState } from 'store/slices'
...
context('AppointmentCancellationConfirmation', () => {
  ...
  const initializeTestInstance = (errorsState: ErrorsState = initialErrorsState) => {
    ...
    component = render(<AppointmentCancellationConfirmation {...props} />, {
      preloadedState: {
        ...InitialState,
        errors: errorsState,
      },
