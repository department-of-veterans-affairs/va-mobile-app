...
context('NoVaccineRecords', () => {
  ...
  describe('when mrHide36HrHoldTimes is false', () => {
    it('initializes correctly with 36 hour text', () => {
      ...
      expect(screen.getByRole('heading', { name: "We couldn't find information about your vaccines" })).toBeTruthy()
      expect(
        screen.getByText(
  ...
  describe('when mrHide36HrHoldTimes is true', () => {
    it('initializes correctly without 36 hour text', () => {
      ...
      expect(screen.getByRole('heading', { name: "We couldn't find information about your vaccines" })).toBeTruthy()
      expect(screen.getByText('We update your vaccine records every 24 hours.')).toBeTruthy()
      expect(
        screen.getByText(
          "If you think your vaccine records should be here, call our MyVA411 main information line. We're here 24/7.",
        ),
