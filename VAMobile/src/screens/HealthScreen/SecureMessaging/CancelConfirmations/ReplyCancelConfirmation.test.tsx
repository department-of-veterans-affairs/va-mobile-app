...
import { resetSaveDraftFailed, resetSaveDraftComplete, resetSendMessageFailed } from 'store'
...
context('ReplyCancelConfirmation', () => {
  ...
  describe('on click of the "Cancel and go to message" button', () => {
    it('should call useRouteNavigation, resetSaveDraftFailed, resetSaveDraftComplete, and resetSendMessageFailed', async () => {
