...
import { resetAnalyticsActionStart, resetHasLoadedRecipients, resetSaveDraftComplete, resetSaveDraftFailed, resetSendMessageFailed, updateSecureMessagingTab } from 'store/actions'
...
const ComposeCancelConfirmation: FC<ComposeCancelConfirmationProps> = ({ navigation }) => {
  ...
  const onGoToInbox = (): void => {
    ...
    dispatch(resetAnalyticsActionStart())
