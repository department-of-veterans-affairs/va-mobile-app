...
context('EditDirectDepositScreen', () => {
  ...
  describe('when content is invalid', () => {
    it('should display an AlertBox and field errors', async () => {
      ...
      expect(testInstance.findAllByType(TextView)[16].props.children).toEqual('Please select the type that best describes the account.')
      expect(testInstance.findAllByType(TextView)[18].props.children).toEqual('Please confirm this information is correct.')
    })
  })
