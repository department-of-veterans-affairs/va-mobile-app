...
const importSarahMartinezData = () => {
  return [
    ...
    import('store/api/demo/mocks/sarahMartinez/prescriptions.json'),
    import('store/api/demo/mocks/default/notifications.json'),
    import('store/api/demo/mocks/default/contactInformation.json'),
    import('store/api/demo/mocks/sarahMartinez/getAuthorizedServices.json'),
    ...
    import('store/api/demo/mocks/sarahMartinez/personalInformation.json'),
...
export default importSarahMartinezData
