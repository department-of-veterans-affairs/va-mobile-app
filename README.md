...
Environment variables are specified in .env files for each environment in the VAMobile/env folder. These files are generated by the build-env script using a corresponding base.env file in VAMobile/base-env

#### Adding A New Environment Variable 

Non sensitive environment variables are added in the base .env files for each environment. If you have sensitive variables that you do not want checked into the repository, augment the secrets.json file and build-env script to include them
...
- create a file called secrets.json at the root of the VAMobile folder. Do not check this file in

- this file is of the structure:
...
- Each object in the secrets array is a mapping of .env file and secrets that will be used to create each .env file. 
